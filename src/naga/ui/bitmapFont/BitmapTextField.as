package naga.ui.bitmapFont
{
	...
	public class BitmapTextField extends Bitmap
	{
		 ...
		 * 构造函数。
		 */		
		public function BitmapTextField(size:int)
		{
			this.m_textFormat = new BitmapTextFormat(size);
		}
		...
		public function get textWidth():int
		{
			if (this.m_text && this.m_font)
			{
				...
				for each (var str:String in arr)
				{
					...
					{
						sumWidth += this.m_font.getCharWidth(str.charCodeAt(i)); // 字符宽度
...
//			trace("btf 190:",this.m_text,this.m_font,this.m_width,this.m_height);
			if (this.m_text && this.m_font)// && this.m_width && this.m_height)
			{
//				trace(this.textWidth);
				var bg:BitmapData = new BitmapData(this.textWidth, this.textHeight, true, this.textFormat.backgroundColor);
