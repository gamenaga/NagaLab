package naga.ui.bitmapFont
{
	...
	public class BitmapTextFormat
	{
		 ...
		 * @param align
		 */		
		public function BitmapTextFormat(size:int, backgroundColor:uint=0, letterSpacing:int=0, leading:int=0,
		...
		{
			var clone:BitmapTextFormat = new BitmapTextFormat(this.size, this.backgroundColor, this.letterSpacing, this.leading,
