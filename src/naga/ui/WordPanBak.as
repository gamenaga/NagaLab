package naga.ui
{
	...
	public class WordPanBak extends Bitmap
	{
		...
		public function WordPanBak(htmlText:String, p_color:String = null , alp:Number = 1, isAutoSize:Boolean = false, width:int = 0, height:int = 0, align:String = "center", t_color:String = null, size:int = 0, arrow_x:int = 0,has_btn:int=-1)
		{
//			var words:Bitmap = String2Font39.go(htmlText, size);
			var word_pan:Sprite = new Sprite
		}// end function
...
//			}
//			GetBitmap.go(this);
			Sprite2Bitmap.go(pan_img);
			trace(this.bitmapData.width);
		}// end function
...
//			pan_img.addChild(pan);
//			pan_img.setChildIndex(pan, 0);
