package game
{
    ...
    public class ModeTime extends Mode
    {
        private var clock:Clock;
        public function ModeTime(mode_type:int = 2, t:int = 100, pop_type:int = 0, move_sp:Number = 2, sp_max:int = 488, sp_min:int = 188, g_type:int = 0, silver:int = 0, show_score:Boolean = true)
        {
        ...
        override protected function game_init() : void
        {
			...
			trace("mode_time 31   clock.width  "+ clock.width);
			this.clock.x = (Global.game_view_w - this.clock.width) * 0.5;
			this.clock.y = Global.game_view_h - 30;
