 ...
 **/
package com.loading.core {
	import events.LoaderEvent;
	import loading.LoaderMax;
	import loading.LoaderStatus;
	...
	[Event(name="open", 	type="events.LoaderEvent")]
	...
	[Event(name="complete", type="events.LoaderEvent")]
	...
	[Event(name="unload", 	type="events.LoaderEvent")]
/**
 ...
 */	
	public class LoaderCore extends EventDispatcher {
		...
		/** @private **/
		protected static var _loaderCount:int = 0;
		/** @private **/
		...
		/** @private **/
		protected var _cachedBytesLoaded:int;
		/** @private **/
		protected var _cachedBytesTotal:int;
		/** @private **/
		...
		public function LoaderCore(vars:Object=null) {
			...
			_cachedBytesTotal = (int(this.vars.estimatedBytes) != 0) ? int(this.vars.estimatedBytes) : LoaderMax.defaultEstimatedBytes;
			this.autoDispose = Boolean(this.vars.autoDispose == true);
			_status = (this.vars.paused == true) ? LoaderStatus.PAUSED : LoaderStatus.READY;
			_auditedSize = Boolean(int(this.vars.estimatedBytes) != 0 && this.vars.auditSize != true);
