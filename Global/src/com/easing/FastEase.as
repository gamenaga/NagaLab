 ...
 * 		<li>Qint (easeIn, easeOut, and easeInOut)</li>
 ...
 */
	public class FastEase {
		 ...
		 * @param power The magnitude or power of the ease. For example, Linear is 0, Quad is 1, Cubic is 2, Quart is 3 and Qint and Strong are 4.
		 */
		public static function activateEase(ease:Function, type:int, power:int):void {
