 ...
 */	 
	public class AutoFitArea extends Shape {
		...
		/** @private **/
		protected var _previewColor:int;
		/** @private **/
		 ...
		 */
		public function AutoFitArea(parent:DisplayObjectContainer, x:Number=0, y:Number=0, width:Number=100, height:Number=100, previewColor:int=0xFF0000) {
			super();
			super.x = x;
			super.y = y;
			if (parent == null) {
		 ...
		 * 					<li><b>previewColor : int</b> - The preview color of the AutoFitArea (default is 0xFF0000). To preview, you must set the AutoFitArea's <code>visible</code> property to true (it is false by default).</li>
		 * 				</ul>
		...
		public static function createAround(target:DisplayObject, vars:Object=null, ...args):AutoFitArea {
			...
			var previewColor:int = isNaN(args[7]) ? (("previewColor" in vars) ? int(vars.previewColor) : 0xFF0000) : args[7];
		...
		/** @private **/
		protected function _redraw(color:int):void {
			_previewColor = color;
...
//---- GETTERS / SETTERS ---------------------------------------------------------------------------
		...
		public function get previewColor():int {
			return _previewColor;
		}
		public function set previewColor(value:int):void {
			_redraw(value);
		}
