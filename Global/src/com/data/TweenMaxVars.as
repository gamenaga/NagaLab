...
package com.data {
	...
	import com.motionPaths.MotionPath;
...
//---- PLUGIN REQUIRED -------------------------------------------------------------------------------------------
		 ...
		 */
		public function bevelFilter(distance:Number=4, angle:Number=45, highlightColor:int=0xFFFFFF, highlightAlpha:Number=0.5, shadowColor:int=0x000000, shadowAlpha:Number=0.5, blurX:Number=4, blurY:Number=4, strength:Number=1, quality:int=2, remove:Boolean=false, addFilter:Boolean=false, index:int=-1):TweenMaxVars {
		 ...
		 * @return The TweenMaxVars instance
		 */
		public function circlePath2D(path:MotionPath, startAngle:Number, endAngle:Number, autoRotate:Boolean=false, direction:String="clockwise", extraRevolutions:int=0, rotationOffset:Number=0, useRadians:Boolean=false):TweenMaxVars {
		 ...
		 * 	   var f:Array = mc.filters, i:int; <br />
		 ...
		 * @return The TweenMaxVars instance
		 */
		public function colorMatrixFilter(colorize:int=0xFFFFFF, amount:Number=1, saturation:Number=1, contrast:Number=1, brightness:Number=1, hue:Number=0, threshold:Number=-1, remove:Boolean=false, addFilter:Boolean=false, index:int=-1):TweenMaxVars {
		 ...
		 * @return The TweenMaxVars instance
		 */
		public function dropShadowFilter(distance:Number=4, blurX:Number=4, blurY:Number=4, alpha:Number=1, angle:Number=45, color:int=0x000000, strength:Number=2, inner:Boolean=false, knockout:Boolean=false, hideObject:Boolean=false, quality:int=2, remove:Boolean=false, addFilter:Boolean=false, index:int=-1):TweenMaxVars {
		 ...
		 * @return The TweenMaxVars instance
		 */
		public function glowFilter(blurX:Number=10, blurY:Number=10, color:int=0xFFFFFF, alpha:Number=1, strength:Number=2, inner:Boolean=false, knockout:Boolean=false, quality:int=2, remove:Boolean=false, addFilter:Boolean=false, index:int=-1):TweenMaxVars {
