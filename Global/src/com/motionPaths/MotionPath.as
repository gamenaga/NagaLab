 ...
 */	
	public class MotionPath extends Shape {
		 ...
		 */
		public function lineStyle(thickness:Number=1, color:int=0x666666, alpha:Number=1, pixelHinting:Boolean=false, scaleMode:String="none", caps:String=null, joints:String=null, miterLimit:Number=3, skipRedraw:Boolean=false):void {
