 ...
 */	
	public class CirclePath2D extends MotionPath {		
		 ...
		 */
		public function followerTween(follower:*, endAngle:Number, direction:String="clockwise", extraRevolutions:int=0, useRadians:Boolean=false):String {
			var revolution:Number = useRadians ? Math.PI * 2 : 360;
		 ...
		 */
		public function anglesToProgressChange(startAngle:Number, endAngle:Number, direction:String="clockwise", extraRevolutions:int=0, useRadians:Boolean=false):Number {
			var revolution:Number = useRadians ? Math.PI * 2 : 360;
