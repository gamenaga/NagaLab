...
function createSquare(size:Number, color:int=0xFF0000):Shape {
 ...
 */	
	public class LinePath2D extends MotionPath {		
		...
		/** @private **/
		protected function _insertPoint(point:Point, index:int, skipOrganize:Boolean):void {
		 ...
		 */
		public function insertMultiplePoints(points:Array, index:int=0):void {
		 ...
		 */
		public function getSegmentProgress(segment:int, progress:Number):Number {
			if (_first == null) {
				return 0;
